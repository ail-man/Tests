...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		ObjectName mbeanName = new ObjectName("com.ail.home.jmx.oracle.example:type=Hello");
		...
		ObjectName mxbeanName = new ObjectName("com.ail.home.jmx.oracle.example:type=QueueSampler");
